...
parser = argparse.ArgumentParser(description="PyTorch CIFAR TRADES-AWP Defense")
parser.add_argument(
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        if epoch >= args.awp_warmup:
            awp = awp_adversary.calc_awp(
                inputs_adv=x_adv, inputs_clean=x_natural, targets=target, beta=args.beta
            )

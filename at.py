...
parser = argparse.ArgumentParser(description="PyTorch CIFAR AT Defense")
parser.add_argument(
...
parser.add_argument("--weight-decay", "--wd", default=5e-4, type=float, metavar="W") # original 2e-4, but 5e-4 is better.

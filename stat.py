...
import torchvision
from stat_losses import stat_loss
...
parser = argparse.ArgumentParser(description="PyTorch CIFAR ST-AT Defense")
parser.add_argument(
...
def train(args, model, device, train_loader, optimizer, epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        (loss, ce_upper, ce_clean, ce_lower) = stat_loss(
            model=model,
            x_natural=data,
            y=target,
            optimizer=optimizer,
